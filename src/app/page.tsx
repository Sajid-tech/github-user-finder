...
export default function Home() {
  const [userName, setUserName] = useState("Sajid-tech");
  // from docs
  ...
  function handleSumbit(e: React.FormEvent<HTMLFormElement>): void {
    e.preventDefault();
    refetch();
  }
            ...
            <main className="flex w-full flex-col gap-5 rounded-lg bg-white dark:bg-slate-800 px-4 py-8  min-h-[200px]">
              ...
              <section className="flex gap-4">
                ...
                <section className="flex flex-col justify-between gap-1 transition-all sm:w-full sm:flex-row">
                  ...
                  <p className="">
                    <span>Joined</span>
                    <span> {dateformt(data?.created_at, "dd mmm yyyy")} </span>
                  </p>
                </section>
              </section>
              {/* 2 */}
